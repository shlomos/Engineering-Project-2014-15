...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::createAndSmoothSurface(vtkSmartPointer<vtkImageData> vtkBinaryImage, unsigned int smoothIteations)
{

	vtkSmartPointer<vtkContourFilter> vtkContourFilter = vtkContourFilter::New();
	vtkContourFilter->SetInputData(vtkBinaryImage);
	...
	smoother->SetInputData(vtkContourMesh);
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::polyDataToMinCurvature(vtkSmartPointer<vtkPolyData> mesh)
{
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::polyDataToMaxCurvature(vtkSmartPointer<vtkPolyData> mesh)
{
...
void MeshLeaksCorrector::writePolyData(vtkSmartPointer< vtkPolyData> mesh, const char *fileName)
{
...
vtkSmartPointer<vtkIdList> MeshLeaksCorrector::GetConnectedVertices(vtkSmartPointer<vtkPolyData> mesh, int id)
{
...
vtkSmartPointer<vtkIdList> MeshLeaksCorrector::GetConnectedTriangles(vtkSmartPointer<vtkPolyData> mesh, int id)
{
	vtkSmartPointer<vtkIdList> connectedVertices =
		vtkSmartPointer<vtkIdList>::New();
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::minCut(vtkSmartPointer<vtkPolyData> curvatureMesh, vtkSmartPointer<vtkPolyData> seedMesh
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::minCutConjunction(vtkSmartPointer<vtkPolyData> minCutMeshLeaks,
...
void MeshLeaksCorrector::attributeDilation(vtkSmartPointer<vtkPolyData> minCutMesh, int dilationRadius)
{
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::laplaceInterpolation(vtkSmartPointer<vtkPolyData> curvatureMesh)
{
	int num_of_nodes = curvatureMesh->GetNumberOfPoints();
...
vtkSmartPointer<vtkDoubleArray> MeshLeaksCorrector::laplaceNormalsInterpolation(vtkSmartPointer<vtkPolyData> curvatureMesh)
{
	...
	normals->SetInputData(curvatureMesh);
...
void MeshLeaksCorrector::computeTriangleCenter(double vertices[3][3], double center[3])
{
...
void MeshLeaksCorrector::computeTriangleNormal(double vertices[3][3], double normal[3])
{
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::laplaceWeightedInterpolation(vtkSmartPointer<vtkPolyData> curvatureMesh)
{
	int num_of_nodes = curvatureMesh->GetNumberOfPoints();
	// Create the sparse matrix
	std::vector<int> linearSystemIDs;
...
void MeshLeaksCorrector::computeTriangleNewCoordinates(double oldVerticesCoordinates[3][3], double center[3], double oldNormal[3], double newNormal[3]
								   ,double newVerticesCoordinates[3][3])
{
	...
	transformFilter->SetInputData(triangle);
...
void MeshLeaksCorrector::computeCellNormals(double vertex1Normals[3], double vertex2Normals[3], double vertex3Normals[3], double cellNormal[3])
{
...
void MeshLeaksCorrector::computeLaplaceOperator(vtkSmartPointer<vtkPolyData> mesh)
{
...
vtkSmartPointer<vtkDoubleArray> MeshLeaksCorrector::laplaceLaplaceInterpolation(vtkSmartPointer<vtkPolyData> mesh)
{
	int num_of_nodes = mesh->GetNumberOfPoints();
	// Create the sparse matrix
	std::vector<int> linearSystemIDs;
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::poissonLaplaceInterpolation(vtkSmartPointer<vtkPolyData> mesh)
{
	int num_of_nodes = mesh->GetNumberOfPoints();
	// Create the sparse matrix
	std::vector<int> linearSystemIDs;
...
vtkSmartPointer<vtkPolyData> MeshLeaksCorrector::normalsLinearInterpolation(vtkSmartPointer<vtkPolyData> mesh)
{
