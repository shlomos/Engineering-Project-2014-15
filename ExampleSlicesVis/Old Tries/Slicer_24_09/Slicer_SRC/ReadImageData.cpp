...
int main(int argc, char* argv[])
{
	...
	lut->SetTableValue((vtkIdType)ACTIVE, 1, 0, 0, 1.0);
	lut->Build();
	mapperSel->SetLookupTable(lut);
	//mapperSel->PassAlphaToOutputOn(); //Do we need it?
	...
	myInteractorStyle->SetImageViewer(viewer, 15/*we dont need those 15th any more!*/, 15, selection, selectionA);
